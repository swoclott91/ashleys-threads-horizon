...
- **Active top-nav indicator:** No caret on mega / dropdown triggers. Open or hovered items use a bottom underline (`.at-menu__nav-link::after`) via `[data-open]`, `aria-expanded="true"`, or parent `:hover` / `:focus-within`. Tighter `padding-inline` keeps category labels closer.
